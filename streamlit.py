...
# data = 'www.buyfakebillsonlinee.blogspot.com'
# user_list = data.split() 
# # # print list
# print('list: ', user_list)
# data1 = np.array(user_list)
# # data2 = data1.astype(np.float64)
# # data = scaler.transform([[user_list]])
# # res_data = scaler.inverse_transform(data)


# print(model.predict(loaded_vectorizer.transform([[data1]])))
